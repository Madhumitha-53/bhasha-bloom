...
const translations: Record<Language, TranslationKeys> = {
  en: {
    ...
    aiExplanationLabel: "AI Analysis",
  ...
  hi: {
    ...
    aiExplanationLabel: "AI विश्लेषण",
  ...
  ta: {
    ...
    financialLure: "நிதி கவர்ச்சி",
    aiExplanationLabel: "AI பகுப்பாய்வு",
  ...
  te: {
    ...
    impersonation: "అనుకరణ",
    financialLure: "ఆర్థిక ప్రలోభం",
    aiExplanationLabel: "AI విశ్లేషణ",
  ...
  kn: {
    ...
    impersonation: "ವೇಷಧಾರಣೆ",
    financialLure: "ಹಣಕಾಸು ಆಮಿಷ",
    aiExplanationLabel: "AI ವಿಶ್ಲೇಷಣೆ",
